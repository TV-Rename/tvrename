...
Section "Install"
    ...
    File "TVRename\bin\Release\net6.0-windows\runtimes\win-x64\native\*.exe"
    File /nonfatal TVRename\packages\cef.redist.x64\102.0.10\CEF\*.dll
    File /nonfatal TVRename\packages\cef.redist.x64\*\CEF\*.pak
    File /nonfatal TVRename\packages\cef.redist.x64\*\CEF\*.bin
    ...
    File "TVRename\bin\Release\net6.0-windows\runtimes\win-x86\native\*.exe"
    File /nonfatal TVRename\packages\cef.redist.x86\*\CEF\*.dll
    File /nonfatal TVRename\packages\cef.redist.x86\*\CEF\*.pak
    File /nonfatal TVRename\packages\cef.redist.x86\*\CEF\*.bin
