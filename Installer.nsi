...
Section "Install"
    ...
    File "TVRename\bin\Release\net6.0-windows\runtimes\win-x64\native\*.exe"
    File "TVRename\bin\Release\net6.0-windows\runtimes\win-x64\native\*.json"
    File /r TVRename\packages\cef.redist.x64\104.4.240\CEF\*.dll
    File /r TVRename\packages\cef.redist.x64\104.4.240\CEF\*.pak
    File /r TVRename\packages\cef.redist.x64\104.4.240\CEF\*.bin
    File /r TVRename\packages\cef.redist.x64\104.4.240\CEF\*.dat
    File /r TVRename\packages\cef.redist.x64\104.4.240\CEF\*.json
    ...
    File "TVRename\bin\Release\net6.0-windows\runtimes\win-x86\native\*.exe"
    File "TVRename\bin\Release\net6.0-windows\runtimes\win-x86\native\*.json"
    File /r TVRename\packages\cef.redist.x86\104.4.240\CEF\*.dll
    File /r TVRename\packages\cef.redist.x86\104.4.240\CEF\*.pak
    File /r TVRename\packages\cef.redist.x86\104.4.240\CEF\*.bin
    File /r TVRename\packages\cef.redist.x86\104.4.240\CEF\*.dat
    File /r TVRename\packages\cef.redist.x86\104.4.240\CEF\*.json
