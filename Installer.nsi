...
Section "Install"
    ...
    File "TVRename\bin\Release\CefSharp.Core.Runtime.dll"
    File "TVRename\bin\Release\CefSharp.dll"
    File "TVRename\bin\Release\CefSharp.WinForms.dll"
    File "TVRename\bin\Release\chrome_elf.dll"
