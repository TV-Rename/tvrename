...
Section "Uninstall"
    ...
    Delete "$INSTDIR\x64\libcrypto-1_1-x64.dll"
    Delete "$INSTDIR\x64\libcurl.dll"
    Delete "$INSTDIR\x64\libssl-1_1-x64.dll"
    Delete "$INSTDIR\x64\MediaInfo.dll"

    Delete "$INSTDIR\x86\libcrypto-1_1.dll"
    Delete "$INSTDIR\x86\libcurl.dll"
    Delete "$INSTDIR\x86\libssl-1_1.dll"
