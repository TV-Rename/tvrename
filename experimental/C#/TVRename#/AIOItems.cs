...
namespace TVRename
{
    ...
    public class AIODownload : AIOItem
    {
        ...
        public AIODownload(ShowItem si, ProcessedEpisode pe, FileInfo dest, string bannerPath)
            : base(AIOType.kDownload, pe)
        {
            Destination = dest;
            SI = si;
    ...
    public class AIOCopyMoveRename : AIOItem
    {
        ...
        public AIOCopyMoveRename(Op operation, FileInfo from, FileInfo to, ProcessedEpisode ep)
            : base(AIOType.kCopyMoveRename, ep)
        {
            Operation = operation;
            From = from;
            To = to;
    ...
    public class AIOMissing : AIOItem
    {
        ...
        public AIOMissing(ProcessedEpisode pe, string whereItShouldBeNoExt)
            : base(AIOType.kMissing, pe)
        {
    ...
    public class AIORSS : AIOItem
    {
        ...
        public AIORSS(RSSItem rss, string toWhereNoExt, ProcessedEpisode pe)
            : base(AIOType.kRSS, pe)
        {
            PE = pe;
            RSS = rss;
    ...
    public class AIONFO : AIOItem
    {
        ...
        public AIONFO(FileInfo nfo, ProcessedEpisode pe)
            : base(AIOType.kNFO, pe)
        {
            SI = null;
            Where = nfo;
        }
        ...
        public AIONFO(FileInfo nfo, ShowItem si)
            : base(AIOType.kNFO, null)
        {
            SI = si;
            Where = nfo;
        }
    ...
    public class AIOuTorrenting : AIOItem
    {
        ...
        public AIOuTorrenting(TorrentEntry te, ProcessedEpisode pe, string desiredLocationNoExt)
            : base(AIOType.kuTorrenting, pe)
        {
