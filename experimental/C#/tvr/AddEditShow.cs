...
#region Windows Form Designer generated code
		...
		private void InitializeComponent()
		{
			...
			this.chkFolderPerSeason.CheckedChanged += new System.EventHandler(chkFolderPerSeason_CheckedChanged);
			// 
			// txtSeasonFolderName
			// 
			...
			this.bnBrowse.Click += bnBrowse_Click;
			// 
			// chkAutoFolders
			// 
			...
			this.chkAutoFolders.CheckedChanged += new System.EventHandler(chkAutoFolders_CheckedChanged);
			// 
			// cbDoRenaming
			// 
			...
			this.cbDoMissingCheck.CheckedChanged += new System.EventHandler(cbDoMissingCheck_CheckedChanged);
			// 
			...
			this.chkPadTwoDigits.CheckedChanged += new System.EventHandler(chkPadTwoDigits_CheckedChanged);
			// 
			// lvSeasonFolders
			// 
			this.lvSeasonFolders.Columns.AddRange(new System.Windows.Forms.ColumnHeader[2] {this.columnHeader1, this.columnHeader2});
			...
			this.txtSeasonNumber.TextChanged += new System.EventHandler(txtSeasonNumber_TextChanged);
			// 
			// txtFolder
			// 
			...
			this.txtFolder.TextChanged += txtFolder_TextChanged;
			// 
			// bnBrowseFolder
			// 
			...
			this.chkCustomShowName.CheckedChanged += new System.EventHandler(chkCustomShowName_CheckedChanged);
			// 
			// AddEditShow
			// 
