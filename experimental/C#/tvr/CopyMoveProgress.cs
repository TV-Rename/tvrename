    ...
    public class CopyMoveProgress : System.Windows.Forms.Form
    {
        ...
        private void copyTimer_Tick(object sender, System.EventArgs e)
        {
            ...
            else
            {
                ...
                if (aio.Type == AIOType.kCopyMoveRename)
                    ...
                    toWhere = new FileInfo(((AIORSS)(aio)).TheFileNoExt).Directory;
        ...
        private void CopyMachine()
        {
            ...
            for (int i = 0; i < mToDo.Count; i++)
            {
                ...
                {
                    this.BeginInvoke(this.Filename, aio1.FilenameForProgress());
                ...
                else if (aio1.Type == AIOType.kCopyMoveRename)
                {
                    ...
                    this.BeginInvoke(Filename, aio.FilenameForProgress());
                    ...
                    else
                    {
                        ...
                        catch (System.Exception e)
                        {
                            ...
                            {
                                msw.Close();
                                if (File.Exists(TempFor(aio.To)))
                                    File.Delete(TempFor(aio.To));
                            }
                            if (msr != null)
                                msr.Close();
