...
//C++ TO C# CONVERTER NOTE: Enums must be named in C#, so the following enum has been named AnonymousEnum:
	...
	public class TVSettings
	{
		...
		public System.Collections.Generic.List<FilenameProcessorRE > FNPRegexs;
		...
		public System.Collections.Generic.List<string> RSSURLs;
		...
		{
			FNPRegexs = new System.Collections.Generic.List<FilenameProcessorRE >();
			...
			RSSURLs = new System.Collections.Generic.List<string >();
			...
			// ResumeDatPath
			FileInfo f = new FileInfo(System.Windows.Forms.Application.UserAppDataPath+"\\..\\..\\..\\uTorrent\\resume.dat");
			if (f.Exists)
		...
		public static System.Collections.Generic.List<FilenameProcessorRE > DefaultFNPList()
		{
			Generic.List<FilenameProcessorRE > l = new System.Collections.Generic.List<FilenameProcessorRE >();
...
//	string BTSearchURL(ProcessedEpisode epi);
	}
