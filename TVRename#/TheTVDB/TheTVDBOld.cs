...
namespace TVRename
{
    ...
    public class TheTVDBOld
    {
        ...
        private static volatile TheTVDBOld instance;
        private static object syncRoot = new Object();

        public static TheTVDBOld Instance
        {
            get
            {
                if (instance == null)
        ...
        private static string BuildBannerURL(bool withHttpAndKey, int code)
        {
            string r = withHttpAndKey ? "http://thetvdb.com/api/" + APIKey() + "/" : "";
        ...
        private string GetURL(string url, bool useKey, typeMaskBits mirrorType)
        {
            string mirr = "";
            switch (mirrorType)
            {
        ...
        public byte[] GetTVDBDownload(string url) { return GetPage(url, false, typeMaskBits.tmBanner, false); }

        private byte[] GetPage(string url, bool useKey, typeMaskBits mirrorType, bool forceReload)
        {
        ...
        private bool ProcessUpdateList(Stream str)
        {
        ...
        private bool ProcessTVDBResponse(Stream str, Stream bannerStr, int? codeHint)
        {
        ...
        private void ProcessTVDBBannerCacheResponse(XmlReader r)
        {
        ...
        private bool ProcessTVDBBannerResponse(Stream str, int? codeHint)
        {
        ...
        private void ProcessTVDBBannerResponse(XmlReader r, int? codeHint)
        {
            r.Read();
        ...
        private bool ProcessTVDBResponse(Stream str, int? codeHint)
        {
