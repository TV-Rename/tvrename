...
namespace TVRename
{
    ...
    public partial class ShowSummary : Form
    {
        ...
        public StringList mFoldersToOpen;
        public List<FileInfo> mLastFL;
        ...
        {
            TheTVDB db = this.mDoc.GetTVDB(true, "ShowSummary");
        ...
        private ShowSummaryData.ShowSummarySeasonData getSeasonDetails(ShowItem si, SeriesInfo ser, int snum)
        {
            ...
            if ((snum >= 0) && (ser.Seasons.ContainsKey(snum)))
            {
                ...
                foreach (ProcessedEpisode ei in eis)
                {
                    ...
                    List<FileInfo> fl = this.mDoc.FindEpOnDisk(ei);
                    if (fl != null)
                    {
                        if (fl.Count != 0)
                            epGotCount++;
        ...
        public void TVDBFor(Season seas)
        {
            ...
            TVDoc.SysOpen(this.mDoc.GetTVDB(false, "").WebsiteURL(seas.TheSeries.TVDBCode, seas.SeasonID, false));
        }
        ...
        private class ShowClickEvent : SourceGrid.Cells.Controllers.ControllerBase
        {
            ...
            public override void OnMouseDown(SourceGrid.CellContext sender, MouseEventArgs e)
            {
                ...
                this.gridSummary.mLastFL = new List<FileInfo>();
                this.gridSummary.mFoldersToOpen = new StringList();
                ...
                if ((seas != null) && (this.show != null) && (this.show.AllFolderLocations(this.gridSummary.mDoc.Settings).ContainsKey(seas.SeasonNumber)))
                {
                    int n = this.gridSummary.mFoldersToOpen.Count;
                    bool first = true;
                    foreach (string folder in this.show.AllFolderLocations(this.gridSummary.mDoc.Settings)[seas.SeasonNumber])
                    {
                ...
                else if (this.show != null)
                {
                    ...
                    foreach (KeyValuePair<int, StringList> kvp in this.show.AllFolderLocations(this.gridSummary.mDoc.Settings))
                    {
                ...
                if (seas != null && this.show != null)
                {
                    ...
                    {
                        List<FileInfo> fl = this.gridSummary.mDoc.FindEpOnDisk(epds);
