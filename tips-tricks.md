...
* TV Rename stores a lot of data in XML files. See ["Under the Hood" - Configuration Files](technical.html#configuration-files "Read the Technical Guide") for more information on what there is, and where it is.
