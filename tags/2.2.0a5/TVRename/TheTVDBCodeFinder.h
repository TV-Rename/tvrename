...
#pragma region Windows Form Designer generated code
        ...
        void InitializeComponent(void)
        {
			...
			this->txtFindThis->KeyDown += gcnew System::Windows::Forms::KeyEventHandler(this, &TheTVDBCodeFinder::txtFindThis_KeyDown);
			// 
			// lvMatches
			// 
			this->lvMatches->Anchor = static_cast<System::Windows::Forms::AnchorStyles>((((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Bottom) 
				...
				| System::Windows::Forms::AnchorStyles::Right));
			this->lvMatches->Columns->AddRange(gcnew cli::array< System::Windows::Forms::ColumnHeader^  >(3) {this->columnHeader1, this->columnHeader2, 
				this->columnHeader3});
			...
			// columnHeader3
			// 
			this->columnHeader3->Text = L"Year";
...
#pragma endregion
                 ...
                 {				 
                     ...
                     for each (KeyValuePair<int, SeriesInfo^> ^kvp in mTVDB->GetSeriesDict())
                     {
                             ...
                             (numeric && show->Contains(what)) )
                         {
							 ...
							 if (kvp->Value->FirstAired != nullptr)
	...
	private: System::Void txtFindThis_KeyDown(System::Object^  sender, System::Windows::Forms::KeyEventArgs^  e) 
			 {
				 if ((e->KeyCode == Keys::Enter)||(e->KeyCode == Keys::Return))
				 {
					 bnGoSearch_Click(nullptr,nullptr);
					 e->Handled = true;
				 }
			 }
};
