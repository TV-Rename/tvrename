...
namespace TVRename
{
    partial class BulkAddShow
    {
        ...
        private void InitializeComponent()
        {
            ...
            ((System.ComponentModel.ISupportInitialize)olFMNewShows).BeginInit();
            SuspendLayout();
            // 
            // bnCheck1
            // 
            ...
            // tbResults
            // 
            tbResults.Controls.Add(olFMNewShows);
            ...
            // olFMNewShows
            // 
            olFMNewShows.AllColumns.Add(olvFolder);
            olFMNewShows.AllColumns.Add(olvShow);
            olFMNewShows.AllColumns.Add(olvStructure);
            olFMNewShows.AllColumns.Add(olvSourceCode);
            olFMNewShows.AllowDrop = true;
            olFMNewShows.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
            olFMNewShows.Columns.AddRange(new ColumnHeader[] { olvFolder, olvShow, olvStructure, olvSourceCode });
            olFMNewShows.FullRowSelect = true;
            olFMNewShows.Location = new System.Drawing.Point(4, 63);
            olFMNewShows.Name = "olFMNewShows";
            olFMNewShows.ShowCommandMenuOnRightClick = true;
            olFMNewShows.Size = new System.Drawing.Size(982, 374);
            olFMNewShows.SmallImageList = imagesPassFail;
            olFMNewShows.TabIndex = 11;
            olFMNewShows.UseFilterIndicator = true;
            olFMNewShows.UseFiltering = true;
            olFMNewShows.View = View.Details;
            olFMNewShows.SelectedIndexChanged += lvFMNewShows_SelectedIndexChanged;
            olFMNewShows.DragDrop += lvFMNewShows_DragDrop;
            olFMNewShows.DragOver += lvFMNewShows_DragOver;
            olFMNewShows.KeyDown += lvFMNewShows_KeyDown;
            olFMNewShows.MouseDoubleClick += lvFMNewShows_MouseDoubleClick;
            // 
            // olvFolder
            // 
            ...
            // olvShow
            // 
            olvShow.AspectName = "Show";
            olvShow.IsEditable = false;
            olvShow.MinimumWidth = 10;
            olvShow.Searchable = false;
            olvShow.Text = "Show";
            olvShow.Width = 277;
            // 
            // olvStructure
            ...
            olvStructure.Text = "Folder Structure";
            olvStructure.Width = 103;
            // 
            // olvSourceCode
            // 
            olvSourceCode.AspectName = "SourceCode";
            olvSourceCode.MinimumWidth = 30;
            ...
            pbProgress.Location = new System.Drawing.Point(13, 511);
            ...
            ((System.ComponentModel.ISupportInitialize)olFMNewShows).EndInit();
            ResumeLayout(false);
        }
