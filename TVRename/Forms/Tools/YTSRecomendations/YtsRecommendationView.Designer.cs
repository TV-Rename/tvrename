namespace TVRename.Forms
{
    partial class YtsRecommendationView
    {
        ...
        private void InitializeComponent()
        {
            ...
            olvRelated = new BrightIdeasSoftware.OLVColumn();
            olvGenres = new BrightIdeasSoftware.OLVColumn();
            olvRelatedNames = new BrightIdeasSoftware.OLVColumn();
            ...
            lvRecommendations.AllColumns.Add(olvRelated);
            lvRecommendations.AllColumns.Add(olvRelatedNames);
            lvRecommendations.AllowColumnReorder = true;
            lvRecommendations.CellEditUseWholeCell = false;
            lvRecommendations.Columns.AddRange(new System.Windows.Forms.ColumnHeader[] { olvId, olvName, olvYear, olvRating, olvPopular, olvLanguage, olvGenres, olvRelated, olvRelatedNames });
            ...
            // olvRelated
            // 
            olvRelated.AspectName = "NumberRelated";
            olvRelated.Text = "Number Related";
            olvRelated.Width = 70;
            // 
            // olvRelatedNames
            // 
            olvRelatedNames.AspectName = "Related";
            olvRelatedNames.Text = "Related Movies";
            olvRelatedNames.Width = 170;
            // 
            // label1
            // 
